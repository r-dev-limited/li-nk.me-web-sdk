export function parseUrl(url, baseOrigin) {
    try {
        return new URL(url);
    }
    catch {
...
export function extractCid(parsed) {
...
export function extractCidFromHash(hash) {
    if (!hash) {
...
export function extractCidFromUrl(url, baseOrigin) {
